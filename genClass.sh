...
cpp_class_gen()
{
    ...
    echo "$1::$1(void)" >> $1.cpp
    echo "{" >> $1.cpp
    echo "    // std::cout << \"Default constructor called\" << std::endl;" >> $1.cpp
    echo "    return ;" >> $1.cpp
    echo "}" >> $1.cpp
    echo "" >> $1.cpp
    echo "$1::$1($1 const & src)" >> $1.cpp
    echo "{" >> $1.cpp
    echo "    // std::cout << \"Copy constructor called\" << std::endl;" >> $1.cpp
    echo "    *this = src;" >> $1.cpp
    echo "    return ;" >> $1.cpp
    echo "}" >> $1.cpp
    echo "" >> $1.cpp
    echo "$1::~$1(void)" >> $1.cpp
    echo "{" >> $1.cpp
    echo "    // std::cout << \"Destructor called\" << std::endl;" >> $1.cpp
    echo "    return ;" >> $1.cpp
    echo "}" >> $1.cpp
    echo "" >> $1.cpp
    ...
    echo "    {" >> $1.cpp
    echo "        // std::cout << \"Assignation operator called\" << std::endl;" >> $1.cpp
    echo "    }" >> $1.cpp
